...
class UserController {
    async register(req, res) {
        ...
        try {
            ...
            const updatedUser = await UserService.updateUser(newUser._id, { cart: newCart._id });

            return res.status(201).json({ message: "Usuario creado correctamente", user: updatedUser });
        } catch (error) {
